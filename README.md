...
- **맥락 인지형 역할 제어**:
  ...
  - **OPERATOR**(오피스 운영자): 담당 지점의 실시간 점유율 조회부터 효율적인 공간 관리까지, 운영의 효율성을 높여주는 관리 도구를 제공합니다.
  - **PLATFORM_ADMIN**(플랫폼 관리자): 전사 자원 설정부터 시스템 전반의 로그 모니터링까지, 통합 관제 기능을 통한 아키텍처 거버넌스를 실현합니다.
