                ...
                mockMvc.perform(post("/api/offices")
                                ...
                                .andDo(document("office-create",
                                                requestFields(
                                                                ...
                                                                fieldWithPath("openDays").type(JsonFieldType.ARRAY)
                                                                                .description("영업 요일 (1=월~7=일)")
                                                                                .optional()),
                                                responseFields(
                                                                ...
                                                                fieldWithPath("data.longitude")
                                                                                .type(JsonFieldType.NUMBER)
                                                                                .description("경도").optional(),
                                                                fieldWithPath("data.openTime")
                                                                                .type(JsonFieldType.STRING)
                                                                                .description("영업 시작 시간 (HH:mm:ss)"),
                                                                fieldWithPath("data.closeTime")
                                                                                .type(JsonFieldType.STRING)
                                                                                .description("영업 종료 시간 (HH:mm:ss)"),
